        ...
        case 1:
          ...
          do {
            ...
            if (!juego.comprobarPalabraValida(palabraUsuario)) {
              ...
              visualWordle.pintarLetraTeclado(juego);
              intentos++;
  ...
  public void menuBancoLetras() {
    ...
    do {
      ...
      switch (opcion) {
        ...
        case 1:
          System.out.println("dame una posicion para leer del archivo");
        ...
        case 2:
          System.out.println("" + extraerPalabra.palabraAleatoria());
          break;
        case 3:
          extraerPalabra.mostrarArregloArchivo();
          break;

        case 4:
          System.out.println("Cual palabra busca");
